...
function redisAllTypesCreateTest() returns error? {
    ...
    AllTypes allTypesRetrieved = check testEntitiesClient->/alltypes/[allTypes1.id];
...
function redisAllTypesCreateOptionalTest() returns error? {
    ...
    AllTypes allTypesRetrieved = check testEntitiesClient->/alltypes/[allTypes3.id];
...
function redisAllTypesReadTest() returns error? {
    ...
    stream<AllTypes, error?> allTypesStream = testEntitiesClient->/alltypes;
    AllTypes[] allTypes = check from AllTypes allTypesRecord in allTypesStream order by allTypesRecord.id ascending
...
function redisAllTypesDeleteTest() returns error? {
    ...
    stream<AllTypes, error?> allTypesStream = testEntitiesClient->/alltypes;
    AllTypes[] allTypesCollection = check from AllTypes allTypesRecord in allTypesStream order by allTypesRecord.id 
